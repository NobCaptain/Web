...
CREATE TABLE `users` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '用户id号',
  `username` varchar(45) NOT NULL COMMENT '用户名称',
  `password` varchar(45) NOT NULL COMMENT '用户密码',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '用户账号状态\n0表示正常\n1表示禁用',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (5,'zs','123',0),(6,'ls','abc231',1),(8,'lq','abs123',0),(9,'asd','fdsaas',1);
...
-- Dump completed on 2024-06-11  0:14:05
